...
export default function HassSection({ locale }: Props) {
  ...
  const whatsappPreset =
    locale === "en"
      ? "Hello! I'm interested in Hass avocado availability, pricing and delivery options. Thank you!"
      : "¡Hola! Me interesa conocer disponibilidad, precios y opciones de entrega de aguacate Hass. ¡Gracias!";
