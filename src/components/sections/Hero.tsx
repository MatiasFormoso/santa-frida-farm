...
export default function Hero({ t }: Props) {
  return (
    ...
    >
      <picture>
        <source srcSet="/images/hero-1920-optimized.webp" type="image/webp" />
      ...
      <div aria-hidden className="absolute inset-0 pointer-events-none bg-black/30" />
        ...
        <div className="w-full flex justify-center sm:justify-start px-4 sm:px-0">
          <div className="w-full max-w-4xl sm:pl-4 lg:pl-0 text-center sm:text-left">
            ...
            >
              ...
              <a
                href="#frase-homenaje"
                className="group inline-flex items-center justify-center gap-1.5 sm:gap-2 px-5 sm:px-6 md:px-7 py-3.5 sm:py-3.5 text-base sm:text-base font-semibold text-white border border-white/60 rounded-full backdrop-blur-md bg-black/60 shadow-xl hover:bg-black/70 hover:border-white/80 transition-all duration-300 whitespace-nowrap"
              >
